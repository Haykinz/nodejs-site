...
$(document).ready(function() {
  ...
  var currentHover = $('.addetails .content .images .large').attr('src');
  $('.addetails .content .images ul.thumbnails li img').hover(function() {                      
    $('.addetails .content .images .large').attr('src', $(this).attr('data-src'));
  }, function () {
    $('.addetails .content .images .large').attr('src', currentHover);
  });
